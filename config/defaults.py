...
# Number of PAM blocks
_C.MODEL.MULTI_NUMS = 1
...
# Mask directory
_C.DATASETS.PROPOSAL_DIR = ('/home/xinyu/Vehicle-ReID/datasets/masks/VeRi/masks_14x14_expcar/')
# Number of part masks
_C.DATASETS.PROPOSAL_NUM = 8
# Test folder
_C.DATASETS.FOLDER = 'large'
# Test index
_C.DATASETS.INDEX = 1
...
_C.SOLVER.CLUSTER_LOSS_WEIGHT = 1
_C.SOLVER.ID_LOSS_WEIGHT = 2.0
